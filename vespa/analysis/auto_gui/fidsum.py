# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.3 on Wed Nov  6 21:35:54 2019
#
...
class PanelPrepFidsumUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.FloatPhase0GlobalConst = FloatSpin(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, value=0.0, digits=1, min_val=0.0, max_val=360.0, increment=1.0, agwStyle=FS_LEFT)
        ...
        self.Bind( EVT_FLOATSPIN, self.on_phase0_global_const, self.FloatPhase0GlobalConst)
    ...
    def __do_layout(self):
        ...
        grid_sizer_7 = wx.FlexGridSizer(7, 2, 4, 4)
        ...
        label_12 = wx.StaticText(self.PanelFidCorrectionsAndAveraging, wx.ID_ANY, "Add constant ph0 to each FID [deg]:")
        grid_sizer_7.Add(label_12, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        grid_sizer_7.Add(self.FloatPhase0GlobalConst, 0, 0, 0)
    ...
    def on_phase0_global_const(self, event):  # wxGlade: PanelPrepFidsumUI.<event_handler>
        print("Event handler 'on_phase0_global_const' not implemented!")
        event.Skip()
