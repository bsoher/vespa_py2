...
import vespa.analysis.functors.funct_coil_combine as funct_coil_combine
...
from vespa.analysis.plot_panel_prep_fidsum import PlotPanelPrepFidsum, PlotPanelPrepFidsumSeries
...
class TabPrepFidsum(tab_base.Tab, fidsum.PanelPrepFidsumUI):
    ...
    def initialize_controls(self):
        ...
        wx_util.configure_spin(self.FloatPhase0GlobalConst,70, None, None, (0.0, 360.0))
    ...
    def populate_controls(self, preset=False):
        ...
        self.FloatPhase0GlobalConst.SetValue(self.block.set.phase0_global_const)
...
#             self.block.set.coil_combine_external_filename   = block_raw.data_source
    ...
    def on_phase0_global_const(self, event): 
        value = event.GetEventObject().GetValue()
        self.block.set.phase0_global_const = value
        self.process_and_plot()
