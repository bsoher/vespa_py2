...
import vespa.analysis.splines as splines
...
from vespa.analysis.constrained_levenberg_marquardt import constrained_levenberg_marquardt
    ...
    if set.baseline_method:
        ...
        if set.baseline_method == constants.FitBaselineMethod.BSPLINE_VARIABLE_KNOT:
            ...
            if constants.PYWAVELETS_AVAILABLE:
                ...
                import vespa.analysis.wavelet_filter as wavelet_filter
