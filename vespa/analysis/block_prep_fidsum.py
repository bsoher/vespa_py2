...
class _Settings(object):
    ...
    def __unicode__(self):
        ...
        lines.append("phase0_global_const               : " + unicode(self.phase0_global_const))
    ...
    def deflate(self, flavor=Deflate.ETREE):
        if flavor == Deflate.ETREE:
            ...
            util_xml.TextSubElement(e, "phase0_global_const",               self.phase0_global_const)
